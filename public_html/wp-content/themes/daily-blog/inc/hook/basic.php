...
if( ! function_exists( 'daily_blog_primary_navigation_fallback' ) ) :
	 ...
	 * @since 1.0.0
	 */
	function daily_blog_primary_navigation_fallback() {
		
		echo '<ul>';
			echo '<li><a href="' . esc_url( home_url( '/' ) ) . '">' .esc_html__( 'Home', 'daily-blog' ). '</a></li>';
			wp_list_pages( array(
			'title_li' => '',
			'depth'    => 1,
			'number'   => 5,
...
/**
 * Class daily_blog_Dropdown_Taxonomies_Control
 */
class daily_blog_Dropdown_Taxonomies_Control extends WP_Customize_Control {
    ...
    public function render_content() {
        $dropdown = wp_dropdown_categories(
            array(
                'name'              => 'daily-blog-dropdown-categories-' . $this->id,
                'echo'              => 0,
                'show_option_none'  => __( '&mdash; Select &mdash;', 'daily-blog' ),
                'option_none_value' => '0',
                'selected'          => $this->value(),
                'hide_empty'        => 0,                   
 ...
 */
class daily_blog_Repeater_Text_Control extends WP_Customize_Control {
    ...
    public function render_content() {
        ...
        <label class="repeater-text-input">
            ...
            <a href="#" class="button button-primary btn-add-field"><?php esc_html_e( 'Add New', 'daily-blog' ) ?></a>
 ...
 * @access public
 */
class daily_blog_Customize_Section_Upsell extends WP_Customize_Section {
