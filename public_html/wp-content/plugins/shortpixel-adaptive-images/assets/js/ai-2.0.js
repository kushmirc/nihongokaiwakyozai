...
SPAI.prototype.composeApiUrl = function(doRegister, src, w, h, specialCrop) {
    ...
    switch ( ext ) {
        case 'svg':
            ...
            break;
        case 'png':
            apiUrl = apiUrl + ( spai_settings.extensions_to_nextgenimg.png ? spai_settings.sep + 'to_webp' : '' ) + '/' + src;
            break;
        case 'jpg':
            apiUrl = apiUrl + ( spai_settings.extensions_to_nextgenimg.jpg ? spai_settings.sep + 'to_webp' : '' ) + '/' + src;
            break;
        case 'gif':
            apiUrl = apiUrl + ( spai_settings.extensions_to_nextgenimg.gif ? spai_settings.sep + 'to_webp' : '' ) + '/' + src;
            break;
