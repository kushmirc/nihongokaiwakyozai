						...
						<div class="wonderplugin-gallery-options-tab">
							<table class="wonderplugin-form-table-noborder">
								<tr>
									...
									<p><label>Category area height: <input name="wonderplugin-gallery-categoryheight" type="number" id="wonderplugin-gallery-categoryheight" value="36" class="small-text" /></label></p>
									</td>
								</tr>
