    ...
    function sfsi_generate_other_icon_effect_admin_html($iconName, $arrImg, $arrActiveDesktopIcons, $customIconIndex = -1, $customIconImgUrl = null, $customIconSrNo = null)
    {
        ...
        if (isset($iconName) && !empty($iconName)) {
            ...
            <div <?php echo $attrCustomIconIndex; ?> <?php echo $attrIconName; ?> class="col-md-3 bottommargin20 <?php echo $displayIconClass; ?>">
                ...
                <a <?php echo $attrCustomIconIndex; ?> <?php echo $attrIconName; ?> id="btn_mouseover_other_icon_<?php echo $iconName; ?>" class="mouseover_other_icon_change_link js_mouseover_upload" href="javascript:void(0)" class="mouseover_other_icon" data-nonce="<?php echo wp_create_nonce('plus_MouseOverIcons') ?>"><?php _e('Change', SFSI_PLUS_DOMAIN); ?></a>

                <a <?php echo $attrCustomIconIndex; ?> <?php echo $attrIconName; ?>class="<?php echo $classForRevertLink; ?> mouseover_other_icon_revert_link js_mouseover_revert" href="javascript:void(0)" class="mouseover_other_icon" data-nonce="<?php echo wp_create_nonce('sfsi_premium_deleteIcons') ?>"><?php _e('Revert', SFSI_PLUS_DOMAIN); ?></a>
