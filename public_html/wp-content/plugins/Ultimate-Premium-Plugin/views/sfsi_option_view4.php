			...
			<div class="listing">
				<ul>
					<li>
						...
						<input name="sfsi_plus_gab_manualCounts" type="text" class="input" value="<?php echo (isset($option4['sfsi_plus_gab_manualCounts']) && $option4['sfsi_plus_gab_manualCounts'] != '') ?  $option4['sfsi_plus_gab_manualCounts'] : '20'; ?>" />
					</li>
				</ul>
			</div>
		</div>
