...
<div class="tab9">
	...
	?>
  	<p>
        <?php
            _e('In addition to the email- and follow-icon you can also show a subscription form that maximizes the chances that people subscribe to your site.', SFSI_PLUS_DOMAIN);
        ?>
    </p>
    ...
    <div class="sfsi_plus_tab8_container">
        ...
        <div class="sfsi_plus_tab8_subcontainer sfsi_plus_seprater">
        	<h5 class="sfsi_plus_section_subtitle">
            	<?php  _e( 'The text above the entry field', SFSI_PLUS_DOMAIN ); ?>
            </h5>
