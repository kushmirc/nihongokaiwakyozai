...
<div class="wapper sfsi_mainContainer">
    ...
    <div class="main_contant">
        ...
        <p>
            <?php _e('Simply answer the questions below (at least the first 3) - that`s it!', SFSI_PLUS_DOMAIN); ?>
        </p>
        <p>
            <?php _e('If you have questions, or something doesn`t work as it should, please raise a ', SFSI_PLUS_DOMAIN); ?>
    ...
    <div id="accordion">
        ...
        <!-- step 2 start here -->
        <h3><span>2</span>
            <?php _e('What do you want the icon to do?', SFSI_PLUS_DOMAIN); ?>
        </h3>
    ...
    <div class="tab10">
        <div class="save_export">
            ...
            <div class="export_selections">
                ...
                <div style="font-size: 18px;"><?php _e('or ', SFSI_PLUS_DOMAIN); ?></div>
                <div class="sfsi_premium_import">
                    <input type="file" id="sfsi_premium_file_input" accept="file_extension" name="pic" class="open_file hidden" placeholder="Import" data-nonce="<?php echo $nonce; ?>">
                    <div onclick="importFileOpen()">
                        <?php _e('Import', SFSI_PLUS_DOMAIN); ?>
                    </div>
                </div>
                <div style="font-size: 18px;"><?php _e('selections', SFSI_PLUS_DOMAIN); ?></div>
            </div>
        </div>
