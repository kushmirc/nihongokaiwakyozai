...
<div class="row sfsi_custom_social_data_setting" id="custom_social_data_setting">
    ...
    <div class="row noborder noMariginPaddintTop sfsi_custom_social_data_section_heading">
        <?php _e("Sharing texts & pictures", SFSI_PLUS_DOMAIN); ?></div>
    ...
    <div class="container-fluid">
        ...
        <div class="row noborder noMariginPaddintTop">
            <p><?php _e('You have two options: either you define the sharing texts & pics individually per page/post, or globally, i.e. then the same text & picture will
				get shared across all the pages of your domain.', SFSI_PLUS_DOMAIN); ?></p>
        </div>
            ...
            <div class="tab-content" style="padding-bottom: 0px;width:100%;padding-left:0;">
                ...
                <div class="social_data_post_types tab-pane <?php if ($option5['sfsi_plus_social_sharing_options'] == "posttype") {
                    ...
                    <p class="sfsi_post_info">
                        <?php _e("On the pages where you edit your posts/pages, you’ll see a (new) section where you can define which pictures & text should be shared. This extra section is displayed on the following:", SFSI_PLUS_DOMAIN); ?>
                    </p>
                    <?php
                    ...
                    $arrselectedPostTypes = (isset($option5['sfsi_custom_social_data_post_types_data'])) ? unserialize($option5['sfsi_custom_social_data_post_types_data']) : $arrselectedPostTypes;
                    ...
                    <div>
                        <p class="sfsi_post_info">
                            <?php _e("The picture will be used which you uploaded in the dedicated section for sharing. If you didn't upload a picture there you can also make the plugin use the \"Featured Image\" you uploaded there.", SFSI_PLUS_DOMAIN); ?>
                        </p>
                        ...
                        <label class="cstmdsplsub" style="font-size:16px;"><?php _e("Yes, use the Featured Image if no sharing pic has been uploaded."); ?></label>
                        </div>
                    </div>
                </div>
    ...
    <div class="sfsi_disable_usm_for_ogtags sfsi_disable_usm_for_ogtags_md">
        <div class="radio_section twitterHeading"><?php _e('Pinterest:', SFSI_PLUS_DOMAIN); ?>
        </div>
        <p class="sfsi_disable_usm_meta_text social_twitter" style="">
            <?php _e("Allow visitors to choose which image gets pinned?", SFSI_PLUS_DOMAIN); ?>
        </p>
        ...
        <ul class="sfsi_plus_disable_usm_og_meta_tags_ul">
            <li>
                ...
                <label><?php _e("No, the image I specified in the “Sharing texts & pictures” section will be used", SFSI_PLUS_DOMAIN); ?></label>
            </li>
            <li>
                ...
                <label><?php _e("Yes, the visitors will be given the choice to pin a specific image from a post/page", SFSI_PLUS_DOMAIN); ?></label>
            </li>
        </ul>
        <div class="sfsi_premium_pinterest_positions_section" <?php echo ($sfsi_plus_icon_hover_show_pinterest=='yes') ?  'checked="true"' : '' ;?>>
            <p class="sfsi_disable_usm_meta_text social_twitter" style="margin-top: 27px !important;">
                <?php _e("Pinterest Placement?", SFSI_PLUS_DOMAIN); ?>
            </p>
            <ul class="sfsi_plus_disable_usm_og_meta_tags_ul">
                <li>
                    ...
                    <label><?php _e("Regular Placement", SFSI_PLUS_DOMAIN); ?></label>
                </li>
                <li>
                    ...
                    <label><?php _e("Absolute Placement", SFSI_PLUS_DOMAIN); ?></label>
                </li>
            </ul>
        </div>
    </div>
    ...
    <div id="twitterSettingContainer" style="<?php echo $displayTwtSetting; ?>">
        ...
        <div class="radio_section twitterHeading" style="margin-top: 70px;"><?php _e('Twitter:', SFSI_PLUS_DOMAIN); ?>
        </div>
        ...
        <div class="radio_section fb_url twt_fld_2 social_twitter" style="margin-top: 15px;">
            ...
            <div class="contTwitterCard" style="<?php echo $display; ?>">
                ...
                <p style="margin-left: 237px;padding-top: 7px!important;">
                    <?php _e('Do you want to include pictures and snippets in the tweets?', SFSI_PLUS_DOMAIN); ?></p>
                    ...
                    <div class="sfsiplusicnsdvwrp cardWrapper cardTypeSelector">
                        ...
                        <select class="form-control" id="twitterCardType">
                            ...
                            <option value="summary_large_image" <?php echo ($option5['sfsi_plus_twitter_twtCardType'] == 'summary_large_image') ?  'selected' : ''; ?>>
                                Summary with large image</option>
                        </select>
