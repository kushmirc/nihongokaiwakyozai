<li class="">
			<div class="radio_section tb_4_ck">
            	<input name="sfsi_plus_icon_hover_switch_exclude_custom_post_types" <?php echo ($option8['sfsi_plus_icon_hover_switch_exclude_custom_post_types']=='yes') ?  'checked="true"' : '';?>  type="checkbox" value="yes" class="styled"  />
            </div>        
			<div class="sfsiplus_right_info">
				...
				<?php 
					...
					$defCount 		   = is_array($custom_post_types) ? count($custom_post_types) : 0;

					$exSelect          = $option8['sfsi_plus_icon_hover_list_exclude_custom_post_types'];
					$exSelectCount     = is_array($exSelect) ? count($exSelect) : 0;

					$cpDisplay = ($option8['sfsi_plus_icon_hover_switch_exclude_custom_post_types']=='yes')? "display:block;": "display:none";
				?>
 ...
 <li class="">
			<div class="radio_section tb_4_ck">
            	<input name="sfsi_plus_icon_hover_switch_exclude_taxonomies" <?php echo (isset($option8['sfsi_plus_icon_hover_switch_exclude_taxonomies']) && $option8['sfsi_plus_icon_hover_switch_exclude_taxonomies']=='yes') ?  'checked="true"' : '';?>  type="checkbox" value="yes" class="styled"  />
            </div>        
			...
			<div class="sfsiplus_right_info">
				...
				<?php 
				  ...
				  $arrSfsi_plus_exl_taxonomies_for_icons = (isset($option8['sfsi_plus_icon_hover_list_exclude_taxonomies'])) ? $option8['sfsi_plus_icon_hover_list_exclude_taxonomies'] : array();
				  
				  $sExcount        = sfsiIsArrayOrObject($arrSfsi_plus_exl_taxonomies_for_icons) ? count($arrSfsi_plus_exl_taxonomies_for_icons): 0;

				  $cTDisplay 	   = ($option8['sfsi_plus_icon_hover_switch_exclude_taxonomies']=='yes')? "display:block;": "display:none";				  
				?>
