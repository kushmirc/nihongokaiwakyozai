...
<li class="sfsi_plus_place_on_image_hover rectangle_icons_item_manually">
    <div class="radio_section tb_4_ck">
        ...
        <span class="sfsiplus_toglepstpgspn" ><?php _e("Show a Pinterest icon on images on mouse-over", SFSI_PLUS_DOMAIN); ?></span>
    </div>
    ...
    <div class="sfsiplus_right_info <?php echo $sfsi_plus_icon_hover_show_pinterest=='yes'?'show':'hide'; ?> " >
            <div class="row noborder noMariginPaddintTop">
                ...
                <select name="sfsi_plus_icon_hover_type" value="<?php echo $sfsi_plus_icon_hover_type; ?>" class="sfsi_plus_img_on_hover_input" onchange="sfsi_premium_pinterest_custom_icon" >
                    ...
                    <option value="custom" <?php echo $sfsi_plus_icon_hover_type=="custom"?'selected=selected':''?> ><?php _e('a custom',SFSI_PLUS_DOMAIN);?></option>
                </select>
                <span class="sfsi-premium-pinterest-custom" style="display:<?php echo $sfsi_plus_icon_hover_type=="custom"?"inline-block":"none";  ?>">
                    (
                    <img src="<?php echo $sfsi_plus_icon_hover_custom_icon_url; ?>" style="width:100%;height:100%;max-width:40px;max-height:40px" /> )
                ...
                <div class="text-subscript">
                    <?php _e('Note: in addition to the above rule(s), you can also prevent the pinterest icon to show on images if you add the attributes data-pin-nopin="true" to it, eg.',SFSI_PLUS_DOMAIN) ?> <?php echo htmlentities('<img src="https://your-url/your-pic-name.jpg" alt="My Pic" data-pin-nopin="true" />');?>
                </div>
            </div> 
    </div>
</li>