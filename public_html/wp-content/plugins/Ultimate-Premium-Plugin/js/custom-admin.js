		...
		success: function (i) {
			if (i == "wrong_nonce") {
				...
				"success" == i ?
					...
					(
						global_error = 1,
						sfsiplus_showErrorSuc("error", "Your settings could not be saved. Please see <a href='http://www.ultimatelysocial.com/saving-settings-is-not-working/' style='color:green;font-weight: bold;'>here</a>  what could be the possible issue", 1),
						s = !1
					),
					sfsiplus_afterLoad();
			}
...
function sfsi_plus_update_step2() {
	...
	SFSI.ajax({
		...
		success: function (s) {
			if (s == "wrong_nonce") {
				...
				"success" == s ? (sfsiplus_showErrorSuc("success", "Saved !", 2), sfsipluscollapse("#sfsi_plus_save2"),
					sfsi_plus_depened_sections(true)) : (global_error = 1, sfsiplus_showErrorSuc("error", "Your settings could not be saved. Please see <a href='http://www.ultimatelysocial.com/saving-settings-is-not-working/' style='color:green;font-weight: bold;'>here</a>  what could be the possible issue", 2),
		...
		error: function(jqXHR, textStatus){
			...
			{     
				global_error = 1,
				sfsiplus_showErrorSuc("error", "Your settings could not be saved. Please see <a href='http://www.ultimatelysocial.com/saving-settings-is-not-working/' style='color:green;font-weight: bold;'>here</a>  what could be the possible issue", 2)   
			}
			 sfsiplus_afterLoad();
			//console.log(textStatus,jqXHR);
		}
	...
	SFSI.ajax({
		...
		success: function (s) {
			if (s == "wrong_nonce") {
				...
				"success" == s ? (sfsiplus_showErrorSuc("success", "Saved !", 3), sfsipluscollapse("#sfsi_plus_save3")) : (sfsiplus_showErrorSuc("error", "Your settings could not be saved. Please see <a href='http://www.ultimatelysocial.com/saving-settings-is-not-working/' style='color:green;font-weight: bold;'>here</a>  what could be the possible issue", 3),
					return_value = !1), sfsiplus_afterLoad();
			}
		},
		error: function(jqXHR, textStatus){
			...
			{     
				global_error = 1,
				sfsiplus_showErrorSuc("error", "Your settings could not be saved. Please see <a href='http://www.ultimatelysocial.com/saving-settings-is-not-working/' style='color:green;font-weight: bold;'>here</a>  what could be the possible issue", 3)   
			}
			 sfsiplus_afterLoad();
			//console.log(textStatus,jqXHR);
		},
...
function sfsi_plus_update_step4() {
	...
	var e = SFSI("input[name='sfsi_plus_display_counts']:checked").val(),
		...
		weibo_From = 1 == SFSI("input[name='sfsi_plus_tumblr_countsFrom']").prop("disabled") ? "" : SFSI("input[name='sfsi_plus_tumblr_countsFrom']:checked").val(),
	...
	return SFSI.ajax({
		...
		success: function (s) {
			if (s == "wrong_nonce") {
				...
				"success" == s.res ? (sfsiplus_showErrorSuc("success", "Saved !", 4), sfsipluscollapse("#sfsi_plus_save4"),
					sfsi_plus_showPreviewCounts()) : (sfsiplus_showErrorSuc("error", "Your settings could not be saved. Please see <a href='http://www.ultimatelysocial.com/saving-settings-is-not-working/' style='color:green;font-weight: bold;'>here</a>  what could be the possible issue", 4),
		...
		error: function(jqXHR, textStatus){
			...
			{     
				global_error = 1,
				sfsiplus_showErrorSuc("error", "Your settings could not be saved. Please see <a href='http://www.ultimatelysocial.com/saving-settings-is-not-working/' style='color:green;font-weight: bold;'>here</a>  what could be the possible issue", 4)   
			}
			 sfsiplus_afterLoad();
			//console.log(textStatus,jqXHR);
		},
		...
		success: function (s) {
			if (s == "wrong_nonce") {
				...
				"success" == s ? (sfsiplus_showErrorSuc("success", "Saved !", 5), sfsipluscollapse("#sfsi_plus_save5")) : (global_error = 1,
					sfsiplus_showErrorSuc("error", "Your settings could not be saved. Please see <a href='http://www.ultimatelysocial.com/saving-settings-is-not-working/' style='color:green;font-weight: bold;'>here</a>  what could be the possible issue", 5)), sfsiplus_afterLoad();
			}
		},
		error: function(jqXHR, textStatus){
			if(textStatus === 'timeout')
			{     
				global_error = 1,
				sfsiplus_showErrorSuc("error", "Your settings could not be saved. Please see <a href='http://www.ultimatelysocial.com/saving-settings-is-not-working/' style='color:green;font-weight: bold;'>here</a>  what could be the possible issue", 5)   
			}
			 sfsiplus_afterLoad();
			//console.log(textStatus,jqXHR);
		},
		...
		success: function (s) {
			if (s == "wrong_nonce") {
				...
				"success" == s ? (sfsiplus_showErrorSuc("success", "Saved !", 6), sfsipluscollapse("#sfsi_plus_save6")) : (global_error = 1,
					sfsiplus_showErrorSuc("error", "Your settings could not be saved. Please see <a href='http://www.ultimatelysocial.com/saving-settings-is-not-working/' style='color:green;font-weight: bold;'>here</a>  what could be the possible issue", 6)), sfsiplus_afterLoad();
			}
		},
	...
	SFSI.ajax({
		...
		success: function (s) {
			if (s == "wrong_nonce") {
				...
				"success" == s ? (sfsiplus_showErrorSuc("success", "Saved !", 7), sfsipluscollapse("#sfsi_plus_save7")) : sfsiplus_showErrorSuc("error", "Your settings could not be saved. Please see <a href='http://www.ultimatelysocial.com/saving-settings-is-not-working/' style='color:green;font-weight: bold;'>here</a>  what could be the possible issue", 7),
					sfsiplus_afterLoad();
			}
		},
		error: function(jqXHR, textStatus){
			...
			{     
				global_error = 1,
				sfsiplus_showErrorSuc("error", "Your settings could not be saved. Please see <a href='http://www.ultimatelysocial.com/saving-settings-is-not-working/' style='color:green;font-weight: bold;'>here</a>  what could be the possible issue", 7)   
			}
			 sfsiplus_afterLoad();
			//console.log(textStatus,jqXHR);
		}
...
function sfsi_plus_update_step8() {
	...
	var sfsi_plus_display_before_woocomerce_desc = SFSI('input[name="sfsi_plus_display_before_woocomerce_desc"]:checked').val() || 'no';
	var sfsi_plus_display_after_woocomerce_desc = SFSI('input[name="sfsi_plus_display_after_woocomerce_desc"]:checked').val() || 'no';
	...
	SFSI.ajax({
		...
		success: function (s) {
			if (s == "wrong_nonce") {
				...
				"success" == s ? (sfsiplus_showErrorSuc("success", "Saved !", 8), sfsipluscollapse("#sfsi_plus_save8")) : sfsiplus_showErrorSuc("error", "Your settings could not be saved. Please see <a href='http://www.ultimatelysocial.com/saving-settings-is-not-working/' style='color:green;font-weight: bold;'>here</a>  what could be the possible issue", 8), sfsiplus_afterLoad()
			}
		},
		error: function(jqXHR, textStatus){
			if(textStatus === 'timeout')
			{     
				global_error = 1,
				sfsiplus_showErrorSuc("error", "Your settings could not be saved. Please see <a href='http://www.ultimatelysocial.com/saving-settings-is-not-working/' style='color:green;font-weight: bold;'>here</a>  what could be the possible issue", 8)   
			}
			 sfsiplus_afterLoad();
			//console.log(textStatus,jqXHR);
		}
	...
	SFSI.ajax({
		...
		success: function (s) {
			if (s == "wrong_nonce") {
				...
				"success" == s ? (sfsiplus_showErrorSuc("success", "Saved !", 9), sfsipluscollapse("#sfsi_plus_save9"), sfsi_plus_create_suscriber_form()) : sfsiplus_showErrorSuc("error", "Your settings could not be saved. Please see <a href='http://www.ultimatelysocial.com/saving-settings-is-not-working/' style='color:green;font-weight: bold;'>here</a>  what could be the possible issue", 9),
					sfsiplus_afterLoad();
			}
		},
		error: function(jqXHR, textStatus){
			...
			{     
				global_error = 1,
				sfsiplus_showErrorSuc("error", "Your settings could not be saved. Please see <a href='http://www.ultimatelysocial.com/saving-settings-is-not-working/' style='color:green;font-weight: bold;'>here</a>  what could be the possible issue", 9)   
			}
			 sfsiplus_afterLoad();
			//console.log(textStatus,jqXHR);
		}
...
function sfsi_premium_responsive_icon_intraction_handler() {
	...
	jQuery('.sfsi_premium_responsive_custom_url_hide, .sfsi_premium_responsive_default_url_hide').click(function (event) {
		...
		jQuery(event.target).parent().parent().find('.sfsi_premium_responsive_custom_url_hide').hide();
		jQuery(event.target).parent().parent().find('.sfsi_premium_responsive_url_input').hide();
		jQuery(event.target).parent().parent().find('.sfsi_premium_responsive_default_url_hide').hide();
		jQuery(event.target).parent().parent().find('.sfsi_premium_responsive_default_url_toggler').show();
		jQuery(event.target).parent().parent().find('.sfsi_premium_responsive_custom_url_toggler').show();
	});
...
function sfsi_premium_responsive_open_url(event) {
	jQuery(event.target).parent().find('.sfsi_premium_responsive_custom_url_hide').show();
	jQuery(event.target).parent().find('.sfsi_premium_responsive_default_url_hide').show();
	jQuery(event.target).parent().find('.sfsi_premium_responsive_url_input').show();
