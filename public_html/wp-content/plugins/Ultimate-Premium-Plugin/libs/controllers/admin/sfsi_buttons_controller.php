    ...
    ?>
            ...
            function sfsi_premium_save_export()
            {
                ...
                foreach ($option3 as $key => $value) {
                    if ($key == "sfsi_plus_mouseOver_other_icon_images") {
                        if (is_string($value)) {
                            $mouseOver_other_icon_images = unserialize($value);
                ...
                foreach ($option5 as $key => $value) {
                    if ($key == "sfsi_order_icons_desktop") {
                        if (is_string($value)) {
                            $desktop_icons = unserialize($value);
                    ...
                    if ($key == "sfsi_order_icons_mobile") {
                        if (is_string($value)) {
                            $mobile_icons = unserialize($value);
                        } else if (is_array($value)) {
                            $mobile_icons = $value;
                        }
                    ...
                    if ($key == "sfsi_custom_social_data_post_types_data") {
                        if (is_string($value)) {
                            $custom_social_data_post_types_data = unserialize($value);
                        } else if (is_array($value)) {
                    ...
                    if ($key == "sfsi_premium_url_shortner_icons_names_list") {
                        if (is_string($value)) {
                            $premium_url_shortner_icons_names_list = unserialize($value);
                        } else if (is_array($value)) {
                ...
                foreach ($option8 as $key => $value) {
                    if ($key  == "sfsi_plus_choose_post_types") {
                        if (is_string($value)) {
                            $choose_post_types = unserialize($value);
                        } else if (is_array($value)) {
                    ...
                    if ($key  == "sfsi_plus_choose_post_types_responsive") {
                        if (is_string($value)) {
                            $choose_post_types_responsive = unserialize($value);
                        } else if (is_array($value)) {
                    ...
                    if ($key == "sfsi_plus_taxonomies_for_icons") {
                        if (is_string($value)) {
                            $taxonomies_for_icons = unserialize($value);
                        } else if (is_array($value)) {
                    ...
                    if ($key == "sfsi_plus_list_exclude_custom_post_types") {
                        if (is_string($value)) {
                            $exclude_custom_post_types = unserialize($value);
                        } else if (is_array($value)) {
                    ...
                    if ($key == "sfsi_plus_list_exclude_taxonomies") {
                        if (is_string($value)) {
                            $exclude_taxonomies = unserialize($value);
                        } else if (is_array($value)) {
                    ...
                    if ($key == "sfsi_plus_list_include_custom_post_types") {
                        if (is_string($value)) {
                            $include_custom_post_types = unserialize($value);
                        } else if (is_array($value)) {
                    ...
                    if ($key == "sfsi_plus_icon_hover_list_exclude_custom_post_types") {
                        if (is_string($value)) {
                            $hover_list_exclude_custom_post_types = unserialize($value);
                        } else if (is_array($value)) {
                    ...
                    if ($key == "sfsi_plus_icon_hover_list_exclude_taxonomies") {
                        if (is_string($value)) {
                            $hover_list_exclude_taxonomies = unserialize($value);
                        } else if (is_array($value)) {
                    ...
                    if ($key == "sfsi_plus_icon_hover_list_include_custom_post_types") {
                        if (is_string($value)) {
                            $hover_list_include_custom_post_types = unserialize($value);
                        } else if (is_array($value)) {
                    ...
                    if ($key == "sfsi_plus_icon_hover_list_include_taxonomies") {
                        if (is_string($value)) {
                            $hover_list_include_taxonomies = unserialize($value);
                        } else if (is_array($value)) {
                ...
                foreach ($option9 as $kay => $value) {
                    ...
                    if ($key == "sfsi_plus_responsive_icons") {
                        if (is_string($value)) {
                            $responsive_icons = unserialize($value);
                        } elseif (is_array($value)) {
                ...
                $sfsi_premium_installDate = get_option("sfsi_premium_installDate");
                $sfsi_premium_RatingDiv = get_option("sfsi_premium_RatingDiv");
                $sfsi_premium_footer_sec = get_option("sfsi_premium_footer_sec");
            ...
            function sfsi_premium_file_input()
            {
                if (isset($_POST['import_type'])) {
                    $current_option1 = unserialize(get_option('sfsi_premium_section1_options'));
                    $current_option2 = unserialize(get_option('sfsi_premium_section2_options'));
                    $current_option3 = unserialize(get_option('sfsi_premium_section3_options'));
                    $current_option4 = unserialize(get_option('sfsi_premium_section4_options'));
                    $current_option5 = unserialize(get_option('sfsi_premium_section5_options'));
                    $current_option6 = unserialize(get_option('sfsi_premium_section6_options'));
                    $current_option7 = unserialize(get_option('sfsi_premium_section7_options'));
                    $current_option8 = unserialize(get_option('sfsi_premium_section8_options'));
                    $current_option9 = unserialize(get_option('sfsi_premium_section9_options'));
                    if ($_POST['imports']['option1']) {
                        $imported_option1 =  $_POST['imports']['option1'];
                    } else {
                        $imported_option1 = array();
                    }
                    if ($_POST['imports']['option2']) {
                        $imported_option2 =  $_POST['imports']['option2'];
                    } else {
                        $imported_option2 =  array();
                    }
                    if ($_POST['imports']['option3']) {
                        $imported_option3 =  $_POST['imports']['option3'];
                    } else {
                        $imported_option3 =  array();
                    }
                    if ($_POST['imports']['option4']) {
                        $imported_option4 =  $_POST['imports']['option4'];
                    } else {
                        $imported_option4 =  array();
                    }
                    if ($_POST['imports']['option5']) {
                        $imported_option5 =  $_POST['imports']['option5'];
                    } else {
                        $imported_option5 =  array();
                    }
                    if ($_POST['imports']['option6']) {
                        $imported_option6 =  $_POST['imports']['option6'];
                    } else {
                        $imported_option6 =  array();
                    }
                    if ($_POST['imports']['option7']) {
                        $imported_option7 =  $_POST['imports']['option7'];
                    } else {
                        $imported_option7 =  array();
                    }
                    if ($_POST['imports']['option8']) {
                        $imported_option8 =  $_POST['imports']['option8'];
                    } else {
                        $imported_option8 =  array();
                    }
                    if ($_POST['imports']['option9']) {
                        $imported_option9 =  $_POST['imports']['option9'];
                    } else {
                        $imported_option9 =  array();
                    }
                ...
                if (!is_wp_error($response) || 200 === wp_remote_retrieve_response_code($response)) {
                    ...
                    if (!empty($response)) {
                        ...
                        if (!empty($data) && isset($data['access_token'])) {
                            ...
                            return array("Timed out . please try again after some time");
                        } else {

                            return array("Data not received in correct format:" . $body);
                        }
                    } else {
                        return array("Data not received in correct format, Please try again.");
                    }
                } else {
