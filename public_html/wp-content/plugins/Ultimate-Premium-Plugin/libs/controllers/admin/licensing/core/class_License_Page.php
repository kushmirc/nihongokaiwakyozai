	 	...
	 	<div class='wrap'>
			...
			<?php $license_api = get_sfsi_active_license_api_name();?>
	 		...
	 		<div class="license_api_containter"> 
	 			<label style="font-weight: 500;" class="license_api_name">I bought my plugin on </label><input type="radio" <?php echo strtolower($license_api) == "sellcodes_usm" ? "checked=true" : "" ?> name="license_api_name" value="sellcodes_usm"><label class="license_api_name" for="license_api_name">Sellcodes</label>
