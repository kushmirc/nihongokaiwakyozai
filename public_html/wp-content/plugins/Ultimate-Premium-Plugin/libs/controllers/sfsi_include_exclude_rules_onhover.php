    ...
    if($anySettingSelected){
        ...
        if($is_archive){
            ...
            if ($is_tag){
                ...
                $arrSfsi_plus_list_exclude_taxonomies = (isset($option8['sfsi_plus_icon_hover_list_exclude_taxonomies']))  ?( is_array($option8['sfsi_plus_icon_hover_list_exclude_taxonomies'])? $option8['sfsi_plus_icon_hover_list_exclude_taxonomies'] : unserialize($option8['sfsi_plus_icon_hover_list_exclude_taxonomies']) ) : array();
        ...
        else if ($postid>0 && null!==$post && isset($post->post_type) && 'post'===$post->post_type)
        {
            ...
            else if(isset($option8['sfsi_plus_icon_hover_switch_exclude_custom_post_types']) && $option8['sfsi_plus_icon_hover_switch_exclude_custom_post_types']=="yes")
            {
                ...
                $arrSfsi_plus_list_exclude_custom_post_types = (isset($option8['sfsi_plus_icon_hover_list_exclude_custom_post_types'])) ? unserialize($option8['sfsi_plus_icon_hover_list_exclude_custom_post_types']) : array();
    ...
    if($anySettingSelected){
        ...
        else if ($postid>0 && null!==$post && isset($post->post_type) && 'post'===$post->post_type)
        {
            ...
            else if(isset($option8['sfsi_plus_icon_hover_switch_include_custom_post_types']) && $option8['sfsi_plus_icon_hover_switch_include_custom_post_types']=="yes")
            {
                ...
                $arrSfsi_plus_list_include_custom_post_types = (isset($option8['sfsi_plus_icon_hover_list_include_custom_post_types'])) ? unserialize($option8['sfsi_plus_icon_hover_list_include_custom_post_types']) : array();
