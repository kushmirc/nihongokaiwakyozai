            ...
            if(isset($httpData->engagement->reaction_count)  && isset($httpData->engagement->comment_count)                    
                ...
                if(isset($httpDataWSlash) && false !== $httpDataWSlash ){
                  $httpDataWSlashCount = (isset( $httpDataWSlash->engagement->reaction_count)?$httpDataWSlash->engagement->reaction_count:0)
                                          +(isset( $httpDataWSlash->engagement->comment_count)?$httpDataWSlash->engagement->comment_count:0)
                                          +(isset( $httpDataWSlash->engagement->share_count)?$httpDataWSlash->engagement->share_count:0)
                                          +(isset( $httpDataWSlash->engagement->comment_plugin_count)?$httpDataWSlash->engagement->comment_plugin_count:0);
                }
                if(isset($httpsDataWSlash) && false !== $httpsDataWSlash ){
                  $httspDataWSlashCount = (isset( $httpsDataWSlash->engagement->reaction_count)?$httpsDataWSlash->engagement->reaction_count:0)
                                        +(isset( $httpsDataWSlash->engagement->comment_count)?$httpsDataWSlash->engagement->comment_count:0)
                                        +(isset( $httpsDataWSlash->engagement->share_count)?$httpsDataWSlash->engagement->share_count:0)
                                        +(isset( $httpsDataWSlash->engagement->comment_plugin_count)?$httpsDataWSlash->engagement->comment_plugin_count:0);
              }

                $count = (isset($httpCount)?($httpCount-0):0) + (isset($httpsCount)?($httpsCount-0):0) +  (isset($httpDataWSlashCount)?($httpDataWSlashCount-0):0) + (isset($httspDataWSlashCount)?($httspDataWSlashCount-0):0);
