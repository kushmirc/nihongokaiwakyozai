...
function sfsi_plus_get_single_icon_html($iconName, $shallAddBackIcon, $backIconImgUrl, $frontIconImgUrl, $class, $noMouseOverEffectClass, $data_effect, $new_window, $url, $icon_opacity, $no_follow_attr, $alt_text, $icons_size, $border_radius, $padding_top, $mouseOver_effect_type, $custom_whatsapp_txt = false, $link = false, $title = false, $onclick = "")
{
	...
	if ("yes" === $option3['sfsi_plus_mouseOver'] && "other_icons" == $option3['sfsi_plus_mouseOver_effect_type']) {
		...
		if (!wp_is_mobile()) {
			...
			$icons = "<a " . $customAttr . " class='" . $class . "' data-effect='" . $data_effect . "' " . $new_window . "  href='" . $href . "' " . $onclick . " style='opacity:" . $icon_opacity . "' " . $no_follow_attr . ">";

			$icons .= "<img nopin='nopin' alt='" . $alt_text . "' title='" . $alt_text . "' src='" . $imgUrl . "' height='" . $icons_size . "' width='" . $icons_size . "' style='" . $border_radius . $padding_top . "' class='sfcm sfsi_premium_wicon' data-effect='" . $data_effect . "' />";
			$icons .= '</a>';
		}
	}
...
function sfsi_plus_get_no_follow_attr($option5 = false)
{
	...
	if (
		isset($option5['sfsi_plus_nofollow_links']) && !empty($option5['sfsi_plus_nofollow_links'])
		...
		case "facebook":
			...
			// fb option count is greater than two, show options in tooltip
				...
				if ($option2['sfsi_plus_facebookPage_option'] == "yes") {
					$hoverdiv .= "<div  class='icon1'><a href='" . $url . "' " . sfsi_plus_checkNewWindow($url) . "><img class='sfsi_premium_wicon' nopin=nopin width='auto' height='auto' alt='" . $alt_text . "' title='" . $alt_text . "' src='" . $visit_icon . "'  /></a></div>";
				}
		...
		case "twitter":
			...
			if ($option2['sfsi_plus_twitter_page'] !=	"yes" && $option2['sfsi_plus_twitter_followme']	!=	"yes" && $tweetAboutPage ==	"yes") {
				...
				if ($option2['sfsi_plus_twitter_page'] == "yes") {
					$hoverdiv .= "<div  class='cstmicon1 '><a href='" . $url . "' " . sfsi_plus_checkNewWindow($url) . "><img nopin=nopin width='auto' class='sfsi_premium_wicon' height='auto' alt='Visit Us' title='Visit Us' src='" . $visit_icon . "'  /></a></div>";
				}
				if ($option2['sfsi_plus_twitter_followme'] == "yes" && !empty($twitter_user)) {
					$hoverdiv .= "<div  class='icon1'><a href='" . $followurl . "' " . sfsi_plus_checkNewWindow($url) . "><img nopin=nopin width='auto' src='" . $tweet_follow_icon . "' class='sfsi_premium_wicon' alt='Follow Me' title='Follow Me' ></a></div>";
				}
...
// var_dump()
					$hoverdiv .= "<div class='icon2'><a href='https://twitter.com/intent/tweet?text=" . urlencode($twitter_text) . "' " . sfsi_plus_checkNewWindow($url) . "><img nopin=nopin width='auto' class='sfsi_premium_wicon' src='" . $tweet_icon . "' alt='Tweet' title='Tweet' ></a></div>";
				}
			}
		...
		case "youtube":
			...
			if ($option2['sfsi_plus_youtube_follow'] == "yes") {
				...
				if ($option2['sfsi_plus_youtube_page'] == "yes") {
					$hoverdiv .= "<div  class='icon1'><a href='" . $url . "'  " . sfsi_plus_checkNewWindow($url) . "><img class='sfsi_premium_wicon fdgdg' nopin=nopin alt='" . $alt_text . "' title='" . $alt_text . "' src='" . $visit_icon . "'  /></a></div>";
				}
				if ($option2['sfsi_plus_youtube_follow'] == "yes") {
					$hoverdiv .= "<div  class='icon2' " . $youtube_user . ">" . $socialObj->sfsi_YouTubeSub($youtube_user) . "</div>";
				}
			}
		...
		case "linkedin":
			...
			if (
				...
				if ($option2['sfsi_plus_linkedin_page'] == "yes") {
					$hoverdiv .= "<div  class='icon4'><a href='" . $url . "' " . sfsi_plus_checkNewWindow($url) . "><img class='sfsi_premium_wicon' nopin=nopin alt='" . $alt_text . "' title='" . $alt_text . "' src='" . $visit_icon . "'  /></a></div>";
				}
		...
		case "xing":
			...
			if (
				...
				if (
					...
					$hoverdiv .= "<div class='icon1'><a href='" . urlencode($visitUrl) . "'  " . sfsi_plus_checkNewWindow($visitUrl) . "><img class='sfsi_premium_wicon' nopin=nopin alt='" . $alt_text . "' title='" . $alt_text . "' src='" . $visit_icon . "'  /></a></div>";
				}
	...
	if (isset($icon) && !empty($icon) && filter_var($icon, FILTER_VALIDATE_URL)) {
		...
		//Main div wrpr
		$icons .= "<div style='width:" . $icon_width . "px; height:" . $icon_width . "px;margin-left:" . $icons_space / 2 . "px;margin-right:" . $icons_space / 2 . "px;margin-bottom:" . $margin_bot . "px;transform: none !important;' class='sfsi_premium_wicons shuffeldiv" . $cmcls . " sfsi_premium_tooltip_align_" . strtolower($option5['sfsi_plus_tooltip_alighn']) . " ' >";
		$icons .= "<div style='line-height:0px;' class='sfsiplus_inerCnt' data-othericoneffect='" . $mouseover_other_icons_transition_effect . "'>";
		...
		if ($icon_name == "whatsapp" && isset($sfsi_whatsapp_url_type) && $sfsi_whatsapp_url_type == 'share_page') {
			...
			$icons .= sfsi_plus_get_single_icon_html($icon_name, $shallAddBackIcon, isset($backIconImgUrl) ? $backIconImgUrl : '', isset($frontIconImgUrl) ? $frontIconImgUrl : '', $class, $noMouseOverEffectClass, isset($data_effect) ? $data_effect : '', $new_window, $url, $icon_opacity, $no_follow_attr, $alt_text, $icons_size, $border_radius, $padding_top, $mouseOver_effect_type, $custom_whatsapp_txt, $link, $title);
			...
			$icons .= $socialObj->sfsi_PinIt($mouse_hover_effect, $addClas, $current_url, $iconImg, $icon_opacity);
			...
			if ("other_icons" == $mouseOver_effect_type) {
				...
				if ($shallAddBackIcon) {
					...
					$icons .= $socialObj->sfsi_PinIt($mouse_hover_effect, $addClass, $current_url, $iconImg, $icon_opacity);
				} else {
			...
			$icons .= "<a class='" . $class . " sficn " . $addFrontClass . "' data-effect='" . $mouse_hover_effect . "' $window  href='" . (isset($url) && $url != "" ? $url : '') . "' " . (isset($url) && $url != "" ? $new_window : '') . " style='opacity:" . $icon_opacity . "' " . $no_follow_attr . ">";
			...
			$icons .= "<a class='" . $class . " sficn " . $addFrontClass . "' " . (isset($nonce) ? 'data-nonce=' . $noce : '') . " data-effect='" . $mouse_hover_effect . "' " . $new_window . "  href='" . (isset($url) && $url != "" ? $url : '') . "' " . (isset($url) && $url != "" ? $new_window : '') . " style='opacity:" . $icon_opacity . "' " . $no_follow_attr . (isset($sfsi_premium_wechat_onclick) ? 'onclick=\'' . $sfsi_premium_wechat_onclick . "'" : '') . "  >";
...
{
	global $post;
	if ((isset($option8["sfsi_plus_sticky_bar"]) && $option8["sfsi_plus_sticky_bar"] == "yes") && (isset($option8['sfsi_plus_sticky_icons']['settings']['desktop']) && $option8['sfsi_plus_sticky_icons']['settings']['desktop']  == "yes" && !wp_is_mobile()) || (isset($option8['sfsi_plus_sticky_icons']['settings']['mobile']) && $option8['sfsi_plus_sticky_icons']['settings']['mobile']  == "yes" && wp_is_mobile())) :
		$option2 = unserialize(get_option('sfsi_premium_section2_options', false));
		$option4 = unserialize(get_option('sfsi_premium_section4_options', false));
		if ($option5 == null) {
			$option5 = unserialize(get_option('sfsi_premium_section5_options', false));
		...
		?>
					...
					<div>
						<?php
								...
								$sfsi_premium_open_in = sfsi_plus_checkNewWindow();
								$is_pinterest = false;
								...
								foreach ($sfsi_plus_sticky_icons['default_icons'] as $icon => $icon_config) {
									...
									if (false == $is_pinterest || (true == $is_pinterest && $icon_config['url'] !== "")) {
										$icons .= "\t\t" . "<a " . sfsi_plus_checkNewWindow() . " href='" . ($icon_config['url'] == "" ? $share_url : do_shortcode($icon_config['url'])) . "' style='" . ($icon_config['active'] == 'yes' ? ('display:block') : 'display:none') . ";" . $sfsi_premium_anchor_style . "' class= >" . "\n";
										$icons .= "\t\t\t<div class='sfsi_premium_sticky_icon_item_container sfsi_premium_responsive_icon_" . strtolower($icon) . "_container' >" . "\n";
										$icons .= "\t\t\t\t<img style='max-height: 25px;display:unset;margin:0' class='sfsi_premium_wicon' src='" . SFSI_PLUS_PLUGURL . "images/responsive-icon/" . $icon . ('Follow' === $icon ? '.png' : '.svg') . "'>" . "\n";
										$icons .= "\t\t\t</div>" . "\n";
										$icons .= "\t\t</a>" . "\n\n";
									} else {
										...
										$icons2 .= "\t\t\t\t<img style='max-height: 25px' onclick='event.target.parentNode.click()' src='" . SFSI_PLUS_PLUGURL . "images/responsive-icon/" . $icon . '.svg' . "'>" . "\n";
										$icons2 .= "\t\t\t</div>" . "\n";
										$icons .= $socialObj->sfsi_PinIt('', '', $current_url, $icons2, 1, ($icon_config['active'] == 'yes' ?  'display:inline' : 'display:none') . ";" . $sfsi_premium_anchor_style);
									}
									$is_pinterest = false;
								}
								...
								foreach ($sfsi_plus_sticky_icons_custom_icons as $icon => $icon_config) {
									// var_dump($icon_config);
									$current_url =  $socialObj->sfsi_get_custom_share_link(strtolower($icon), $option5);
									$icons .= "\t\t" . "<a " . sfsi_plus_checkNewWindow() . " " . $sfsi_premium_open_in . " href='" . ($icon_config['url'] == "" ? "" : do_shortcode($icon_config['url'])) . "' style='" . ($icon_config['active'] == 'yes' ? 'display:flex' : 'display:none') . ";" . $sfsi_premium_anchor_style . "'>" . "\n";
