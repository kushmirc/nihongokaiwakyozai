...
function sfsi_plus_add_fields_for_desktop_icons_order_option5($option5 = false, $option1 = false)
{
	...
	$arrIcons = array(
		1 => "rss", 2 => "email", 3 => "fb", 4 => "twitter", 5 => "share", 6 => "youtube", 7 => "pinterest", 8 => "linkedin", 9 => "instagram", 10 => "houzz", 11 => "snapchat",
		12 => "whatsapp", 13 => "skype", 14 => "vimeo", 15 => "soundcloud", 16 => "yummly", 17 => "flickr", 18 => "reddit", 19 => "tumblr", 20 => "fbmessenger", 21 => "mix", 22 => "ok", 23 => "telegram", 24 => "vk", 25 => "weibo", 26 => "xing"
	);
...
function sfsi_plus_add_new_icons_in_saved_desktop_mobile_order($option5 = false, $option1 = false)
{
	...
	$arrNewIcons = array(21 => "fbmessenger", 22 => "mix", 23 => "ok", 24 => "telegram", 25 => "vk", 26 => "weibo", 27 => "xing");
...
function sfsi_plus_update_plugin()
{
	...
	$sfsi_premium_cron = unserialize(get_option('sfsi_premium_cron', false));
	...
	if (!isset($option5['sfsi_plus_icons_ClickPageOpen']) || empty($option5['sfsi_plus_icons_ClickPageOpen'])) {
...
function sfsi_premium_activate_plugin()
{
	...
	$options5 = array(
		...
		'sfsi_plus_fbmessenger_MouseOverText' => "Fb messenger",
...
function sfsi_plus_curl_enable_notice()
{
	...
	if (!function_exists('curl_init')) {
		echo '<div class="error"><p> ' . __('Error: It seems that CURL is disabled on your server. Please contact your server administrator to install / enable CURL.', SFSI_PLUS_DOMAIN) . '</p></div>';
		die;
	}
}
